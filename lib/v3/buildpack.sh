...
bp_install_or_reuse_toolbox() {
  local layer_dir=$1
  local jqUrl="https://buildpacks.oss-accelerate.aliyuncs.com/github.com/stedolan/jq/releases/download/jq-1.5/jq-linux64"
  local jqSha="c6b3a7d7d3e7b70c6f51b706a3b90bd01833846c54d32ca32f0027f00226ff6d"
  local yjUrl="https://buildpacks.oss-accelerate.aliyuncs.com/github.com/sclevine/yj/releases/download/v2.0/yj-linux"
