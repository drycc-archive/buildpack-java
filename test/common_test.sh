...
test_is_supported_maven_version_default() {
  capture is_supported_maven_version "$DEFAULT_MAVEN_VERSION" "https://buildpacks.oss-accelerate.aliyuncs.com/jvm/maven-$DEFAULT_MAVEN_VERSION.tar.gz"
  assertCapturedSuccess
}

test_is_supported_maven_version_old() {
  capture is_supported_maven_version "3.6.2" "https://buildpacks.oss-accelerate.aliyuncs.com/jvm/maven-3.6.2.tar.gz"
  assertCapturedSuccess
}

test_is_supported_maven_version_no() {
  capture is_supported_maven_version "1.1.1" "https://buildpacks.oss-accelerate.aliyuncs.com/jvm/maven-1.1.1.tar.gz"
